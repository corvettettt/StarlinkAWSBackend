# tylerstarlink serverless API
The tylerstarlink project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=tylerstarlink -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=tylerstarlink -Dversion=1.0-SNAPSHOT -Dinteractive=false
$ cd tylerstarlink
$ mvn clean package
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "TylerstarlinkApi",
                    "OutputKey": "TylerstarlinkApi",
